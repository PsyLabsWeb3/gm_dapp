 ...
 */
export function resolveImageFromMetadata(imageField: string, metadataUrl: string): string {
 ...
 */
export function resolveErc1155Uri(template: string, id: bigint | number): string {
