...
function EligibilityTab() {
  ...
  return (
    ...
    >
      ...
      <h2
        className="text-3xl font-bold mb-12 text-center tracking-wider"
        style={{ color: "#F9B064" }}
      >
        <span
          ...
          <div className="flex justify-center mb-12">
            <button
              ...
              style={{
                ...
                backgroundImage:
                  "linear-gradient(180deg, #0C0C0C 0%, #181818 100%), linear-gradient(180deg, #F9B064 0%, rgba(147, 104, 59, 0.27) 100%)",
        ...
        <div className="space-y-4">
          ...
          {!isLoading && !isError && isWhitelisted === false && (
            <div className="space-y-6">
              ...
              >
                Unfortunately, this address is not eligible for the current
                whitelist. However, new portals will open soon... Stay tuned to
          ...
          <div className="flex justify-center mt-8">
            <button
              onClick={handleReset}
              className="text-[#F9B064] underline text-sm cursor-pointer"
            >
...
function BuyTab() {
    ...
    const timer = setTimeout(() => {
      if (!address && !noWalletToastShown.current) {
        const toastId = toast.error(
          "The portal awaits: Connect your wallet to access the presale",
          { duration: 6000 },
        );
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (
        address &&
        isWhitelisted === false &&
        !notWhitelistedToastShown.current
      ) {
        toast.error(
          "The portal remains closed: Your address is not on the presale whitelist",
          { duration: 6000 },
        );
      ...
      <div className="mx-auto" style={{ maxWidth: "1000px" }}>
        ...
        >
          ...
          <div className="text-center space-y-8">
            ...
            >
              The portal has opened in your favor.
              <br />
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div
        className="rounded-3xl p-6 relative overflow-hidden flex flex-col items-center justify-center"
        style={{
          background: "linear-gradient(180deg, #0C0C0C 0%, #181818 100%)",
          border: "3px solid transparent",
          backgroundClip: "padding-box",
...
function ClaimTab() {
  ...
  const { claimMZCAL, isPending, isConfirming, isSuccess, error } =
    useClaimMZCAL();

  const handleClaim = () => {
    if (!address || !formattedBalance || parseFloat(formattedBalance) === 0)
      return;
    claimMZCAL();
  };
